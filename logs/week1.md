...
On top of these could also be subtopics that I can use to automatically detect which sector of traits has any given bug that I'm trying to fix, which are mainly just how each of the main topics go hand-in-hand with each other, along with how well I may have implemented OOP in the changes of that week.
